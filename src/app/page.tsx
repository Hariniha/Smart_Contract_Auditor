...
export default function HomePage() {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-gray-900 via-[#0f1c2e] to-black'>
      ...
      <section
        id='features'
        className='py-20 bg-gradient-to-b from-gray-900 to-[#0f1c2e]'>
        <div className='container mx-auto px-4'>
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            ...
            {[
              {
                ...
                description:
                  'Fast pattern-based vulnerability detection using SWC Registry and known attack vectors',
              },
              {
                ...
                description:
                  'AI-powered reasoning to understand complex business logic, state transitions, and edge cases',
              },
              {
                ...
                description:
                  'SCSVS v2 compliance validation and EthTrust security level assessment',
              },
              {
                ...
                title: 'Smart Reports',
                description:
                  'Comprehensive vulnerability reports with actionable recommendations and risk scoring',
              },
            ].map((card, index) => (
              <motion.div
                key={index}
                ...
                <div className='flex items-start justify-between mb-4'>
                  ...
                  <span
                    className={`text-xs px-3 py-1 rounded-full font-medium ${card.badgeColor}`}>
                    {card.badge}
                  </span>
                </div>
        ...
        <div className='container mx-auto px-4'>
          <motion.div
            ...
            <h2 className='text-3xl md:text-4xl font-bold mb-4 text-gray-900'>
              How to Use SmartAudit
            </h2>
            <p className='text-lg text-gray-600'>
              Get started with our AI-powered smart contract auditor in three
              simple steps
            </p>
          </motion.div>
              ...
              <div className='grid md:grid-cols-2 gap-6'>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-600'>
                      Download comprehensive reports as PDF, structured JSON, or
                      plain text
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-600'>
                      Built-in Monaco editor with syntax highlighting and
                      instant analysis
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-600'>
                      Automatic validation against SCSVS v2 and EthTrust
                      security levels
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-600'>
                      Pre-loaded vulnerable contracts to test and understand
            ...
            {[
              {
                title: 'SWC Registry',
                description:
                  'Smart Contract Weakness Classification with CWE mappings',
                checks: '35+ Weakness Types',
              },
              {
                title: 'SCSVS v2',
                description:
                  'Smart Contract Security Verification Standard Framework',
                checks: '50+ Security Controls',
              },
              {
                title: 'EthTrust Levels',
                description:
                  'Official EthTrust security level classification system',
      ...
      <section className='py-20 bg-white'>
        <div className='container mx-auto px-4'>
          <motion.div
            ...
            <p className='text-lg text-gray-600'>
              Comprehensive security analysis documentation with all the details
              you need
            </p>
          </motion.div>
            ...
            <motion.div
              ...
              <div className='flex justify-center'>
                <div className='text-center max-w-xs'>
                  ...
                  <p className='text-sm text-gray-600'>
                    Professionally structured audit report with detailed
                    findings and security insights
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      <footer className='border-t border-gray-800 py-12 bg-gray-900/50'>
        <div className='mx-auto px-4 max-w-5xl'>
          <div className='flex flex-col md:flex-row justify-center items-start md:items-start gap-16 md:gap-20'>
            ...
            <div className='text-center md:text-left'>
              ...
              <ul className='space-y-2 text-sm text-gray-400'>
                <li>
                  <Link href='/analyzer' className='hover:text-emerald-400 transition'>
                    Analyzer
                  </Link>
                </li>
                <li>
            ...
            <div className='text-center md:text-left'>
              ...
              <ul className='space-y-2 text-sm text-gray-400'>
                <li>
                  <Link href='/documentation' className='hover:text-emerald-400 transition'>
                    Documentation
                  </Link>
                </li>
              </ul>
          ...
          <div className='border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400'>
            © 2026 SmartAudit. Built with SWC Registry, SCSVS v2, and
            EthTrust Standards.
          </div>
        </div>
      </footer>
